...
function RouteComponent() {
  ...
  const certifications = [
    ...
    {
      name: 'Emergency First Responder Primary and Secondary Care Instructor',
      icon: '🚑',
    },
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                Delaware, concentrating in Systems and Networks with a
                cumulative GPA of 3.85 (Computer Science courses: 3.96).
                I&apos;ve been on the Dean&apos;s List for six consecutive
                semesters and have experience as a Technology Intern at CoStar
                Group, Resident Assistant, Lab Assistant, and Scuba Diving
                Instructor. I&apos;ve also served in leadership roles for the
                University&apos;s Sailing Team, including Commodore and
                Boatswain positions.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              whileHover="hover"
            >
              <h1 className="text-3xl font-bold mb-6 bg-gradient-to-r from-yellow-600 to-red-600 bg-clip-text text-transparent">
                Skills
              </h1>
              <motion.div
                className="grid grid-cols-1 md:grid-cols-2 gap-6"

...
const Highlighted = ({ projectData, handleClose }: Props) => {
  const { imageUrl, title, summary, shownLink, link, description } =
    projectData;

  useEffect(() => {
    // When the component mounts, set overflow to hidden
    document.body.style.overflow = "hidden";

    // When the component unmounts, reset overflow
    return () => {
  ...
  return (
    <div className="fixed z-50 inset-0 overflow-y-auto flex justify-center items-center">
      ...
      <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-3/4">
